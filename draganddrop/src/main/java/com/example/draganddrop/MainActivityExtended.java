...
public class MainActivityExtended extends AppCompatActivity {
        ...
        public boolean onDrag(View view, DragEvent event) {
            ...
            switch (action) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    dragInterrupted = draggedViewTag.equals("boat") && draggedToContainerTag.equals("bottomRight");
