 ...
 *  Bruker: getExternalFilesDir(...)
 *  Dersom enhet kjører >= KITKAT (versjon 4.4) trenger man ikke spørre om tillatelser.
 */
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * SKRIV til EKSTERN fil: Dersom enhet kjører >= KITKAT (versjon 4.4) trenger man ikke spørre om tillatelser.
     */
    ...
    /**
     * LES fra EKSTERN fil: Dersom enhet kjører >= KITKAT (versjon 4.4) trenger man ikke spørre om tillatelser.
     */
    ...
    public void readFromExternalFile() {
        ...
        File externalDirectory = this.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS);
