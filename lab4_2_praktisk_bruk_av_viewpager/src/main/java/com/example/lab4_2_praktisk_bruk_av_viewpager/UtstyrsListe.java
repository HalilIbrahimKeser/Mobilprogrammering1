...
public class UtstyrsListe {
    ...
    public UtstyrsListe() {
        ...
        utstyr.add(new Utstyr("TLF","Apple", "S11", new Date().getTime(), 'U', "Per Persen", "https://goo.gl/gEgYUd"));
        ...
        utstyr.add(new Utstyr("ANDROID NETTBRETT","Lenovo", "S14", new Date().getTime(), 'U', "Hanne Persen", "https://kark.uit.no/~wfa004/d3330/images/playstation2.jpg"));
